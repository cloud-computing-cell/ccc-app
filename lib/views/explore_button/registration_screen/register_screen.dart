            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Center(
                    child: Text("Excited for NIMBUS 2.0  !!",
                        style: TextStyle(
                            fontSize: 16,
                            color: Colors.white,
                            fontWeight: FontWeight.bold)),
                  ...
                  Obx(() => !controller.showPaymentSection.value
                      ? GestureDetector(
                          ...
                          child: actionButton(
                              "Next", Color(0xFFE96F6F), Color(0xFF6C4AB6)),
                        )
                      : Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Obx(() => controller.isLoading.value
                                ...
                                : GestureDetector(
                                    onTap: () {
                                      if (controller.transactionIdController.text
                                          .isNotEmpty) {
                                    ...
                                    child: actionButton("Submit",
                                        Color(0xFF6C4AB6), Color(0xFFE96F6F)),
                                  )),
                          ],
                        )),
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButtonFormField<String>(
                ...
                hint: Text(
                  "Select ${label.length > 6 ? '${label.substring(0, 5)}...' : label}",
