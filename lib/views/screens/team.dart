                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            IconButton(
                                              onPressed: () => openSocialMedia(member["github"]),
                                            ...
                                            IconButton(
                                              onPressed: () => openSocialMedia(member["linkedin"]),
                                              icon: SvgPicture.asset(
                                            ...
                                            IconButton(
                                              onPressed: () => openSocialMedia(member["instagram"]),
                                              icon: SvgPicture.asset(
...
class AnimatedWaveSVGBackground extends StatefulWidget {
  ...
  const AnimatedWaveSVGBackground({Key? key, required this.svgAsset}) : super(key: key);

  @override
  State<AnimatedWaveSVGBackground> createState() => _AnimatedWaveSVGBackgroundState();
}
